                  ...
                  <div class="widget box blue" id="form_wizard_1">
                    ...
                    <button onclick="addInput()" type="button" class="btn green"> Add New <i class="icon-plus"></i> </button>
                           ...
                           <div class="control-group">
                              ...
                              <div class="control-group"><label class="control-label">Packages</label><div class="controls"><select id="'+boxName+'" name="packageID" class="span6 chosen" data-placeholder="Choose a Category" tabindex="1"><option value="<?php echo $package_id;?>"><?php echo $package_name;?></option></select></div></div>
...
document.getElementById('responce').innerHTML+='<br/>\
		...
		<span class="help-inline">Remove</span><br/><div class="control-group"><label class="control-label">Packages</label><div class="controls"><select style="display: none;" id="'+boxName+'" name="packageID" class="span6 chosen chzn-done" data-placeholder="Choose a Category" tabindex="-1"><option value="4">Dubai</option></select><div style="width: 39.9121px;" class="chzn-container chzn-container-single" id="__boxName___chzn">\
		<a href="javascript:void(0)" class="chzn-single" tabindex="-1"><span>Dubai</span><div><b></b></div></a><div class="chzn-drop" style="left: -9000px; width: 39.9121px; top: 0px;"><div class="chzn-search"><input tabindex="1" style="width: 31.9121px;" autocomplete="off" type="text"></div><ul class="chzn-results"><li id="__boxName___chzn_o_0" class="active-result result-selected" style="">Dubai</li></ul></div></div></div></div><br/>';
     countBox += 1;
